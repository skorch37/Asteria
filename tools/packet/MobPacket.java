...
public class MobPacket {
    ...
    public static byte[] killMonster(int oid, int animation, boolean azwan) {
        ...
        mplew.writeShort(azwan ? SendPacketOpcode.AZWAN_KILL_MONSTER.getValue() : SendPacketOpcode.KILL_MONSTER.getValue()); // shorter
    ...
    public static byte[] spawnMonster(MapleMonster life, int spawnType, int link, boolean azwan) {
        ...
        mplew.write(0);
        mplew.write(-1);
        mplew.writeZeroBytes(100); // no dc
        return mplew.getPacket();
    }
    ...
    public static byte[] controlMonster(MapleMonster life, boolean newSpawn, boolean aggro, boolean azwan) {
        ...
        mplew.writeShort(azwan ? SendPacketOpcode.AZWAN_SPAWN_MONSTER_CONTROL.getValue() : SendPacketOpcode.SPAWN_MONSTER_CONTROL.getValue());
        if (!azwan) {
