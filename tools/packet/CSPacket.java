...
public class CSPacket {
    ...
    private static final byte Operation_Code = 103;//66

    public static byte[] Use_CS(boolean enable) {
        final MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();

        mplew.writeShort(SendPacketOpcode.CS_USE.getValue());
        mplew.write(enable); // true - send 1 false send 0
    ...
    public static byte[] CS_Top_Items() {
        ...
        mplew.write(cif.getMenuItems(301).size() > 0 ? 2 : 3);
...
//    }
    public static byte[] warpCS(MapleClient c) {
        ...
        mplew.write(HexTool.getByteArrayFromHexString("6C 00 6F 00 6F 00 6E 00 2E 00 20 00 23 00 63 00 44 00 6F 00 75 00 62 00 6C 00 65 00 2D 00 63 00 6C 00 69 00 63 00 6B 00 20 00 74 00 68 00 65 00 20 00 64 00 65 00 73 00 74 00 69 00 6E 00 61 00 74 00 69 00 6F 00 6E 00 20 00 6F 00 6E 00 20 00 74 00 68 00 65 00 20 00 57 00 6F 00 72 00 6C 00 64 00 20 00 4D 00 61 00 70 00 23 00 20 00 74 00 6F 00 20 00 66 00 6C 00 79 00 20 00 74 00 68 00 65 00 72 00 65 00 20 00 61 00 75 00 74 00 6F 00 6D 00 61 00 74 00 69 00 63 00 61 00 6C 00 6C 00 79 00 2E 00 20 00 28 00 41 00 75 00 74 00 6F 00 20 00 50 00 69 00 6C 00 6F 00 74 00 20 00 69 00 73 00 20 00 6F 00 6E 00 6C 00 79 00 20 00 61 00 76 00 61 00 69 00 6C 00 61 00 62 00 6C 00 65 00 20 00 6F 00 6E 00 20 00 73 00 6F 00 6D 00 65 00 20 00 63 00 6F 00 6E 00 74 00 69 00 6E 00 65 00 6E 00 74 00 73 00 2C 00 20 00 69 00 6E 00 63 00 6C 00 75 00 64 00 69 00 6E 00 67 00 20 00 56 00 69 00 63 00 74 00 6F 00 72 00 69 00 61 00 20 00 49 00 73 00 6C 00 61 00 6E 00 64 00 2E 00 20 00 23 00 63 00 42 00 75 00 79 00 20 00 61 00 20 00 46 00 6C 00 69 00 67 00 68 00 74 00 20 00 50 00 65 00 72 00 6D 00 69 00 74 00 20 00 66 00 72 00 6F 00 6D 00 20 00 49 00 6E 00 73 00 74 00 72 00 75 00 63 00 74 00 6F 00 72 00 20 00 49 00 72 00 76 00 69 00 6E 00 23 00 20 00 74 00 6F 00 20 00 75 00 73 00 65 00 20 00 74 00 68 00 65 00 20 00 53 00 6D 00 61 00 72 00 74 00 20 00 4D 00 6F 00 75 00 6E 00 74 00 20 00 6F 00 6E 00 20 00 6D 00 6F 00 72 00 65 00 20 00 63 00 6F 00 6E 00 74 00 69 00 6E 00 65 00 6E 00 74 00 73 00 2E 00 29 00 00 00 76 08 54 FB 0C 3D 4E 00 01 4F 92 43 FD 0E 5C 02 00 00 5B 00 4D 00 61 00 73 00 74 00 65 00 72 00 20 00 4C 00 65 00 76 00 65 00 6C 00 20 00 3A 00 20 00 31 00 5D 00 5C 00 6E 00 46 00 6C 00 79 00 20 00 61 00 63 00 72 00 6F 00 73 00 73 00 20 00 74 00 68 00 65 00 20 00 73 00 6B 00 79 00 20 00 6F 00 6E 00 20 00 61 00 20 00 66 00 6C 00 6F 00 61 00 74 00 79 00 20 00 62 00 61 00 6C 00 6C 00 6F 00 6F 00 6E 00 2E 00 20 00 23 00 63 00 44 00 6F 00 75 00 62 00 6C 00 65 00 2D 00 63 00 6C 00 69 00 63 00 6B 00 20 00 74 00 68 00 65 00 20 00 64 00 65 00 73 00 74 00 69 00 6E 00 61 00 74 00 69 00 6F 00 6E 00 20 00 6F 00 6E 00 20 00 74 00 68 00 65 00 20 00 57 00 6F 00 72 00 6C 00 64 00 20 00 4D 00 61 00 70 00 23 00 20 00 74 00 6F 00 20 00 66 00 6C 00 79 00 20 00 74 00 68 00 65 00 72 00 65 00 20 00 61 00 75 00 74 00 6F 00 6D 00 61 00 74 00 69 00 63 00 61 00 6C 00 6C 00 79 00 2E 00 20 00 28 00 41 00 75 00 74 00 6F 00 20 00 50 00 69 00 6C 00 6F 00 74 00 20 00 69 00 73 00 20 00 6F 00 6E 00 6C 00 79 00 20 00 61 00 76 00 61 00 69 00 6C 00 61 00 62 00 6C 00 65 00 20 00 6F 00 6E 00 20 00 73 00 6F 00 6D 00 65 00 20 00 63 00 6F 00 6E 00 74 00 69 00 6E 00 65 00 6E 00 74 00 73 00 2C 00 20 00 69 00 6E 00 63 00 6C 00 75 00 64 00 69 00 6E 00 67 00 20 00 56 00 69 00 63 00 74 00 6F 00 72 00 69 00 61 00 20 00 49 00 73 00 6C 00 61 00 6E 00 64 00 2E 00 20 00 23 00 63 00 42 00 75 00 79 00 20 00 61 00 20 00 46 00 6C 00 69 00 67 00 68 00 74 00 20 00 50 00 65 00 72 00 6D 00 69 00 74 00 20 00 66 00 72 00 6F 00 6D 00 20 00 49 00 6E 00 73 00 74 00 72 00 75 00 63 00 74 00 6F 00 72 00 20 00 49 00 72 00 76 00 69 00 6E 00 23 00 20 00 74 00 6F 00 20 00 75 00 73 00 65 00 20 00 74 00 68 00 65 00 20 00 53 00 6D 00 61 00 72 00 74 00 20 00 4D 00 6F 00 75 00 6E 00 74 00 20 00"));
        mplew.writeZeroBytes(7);
        mplew.write(138);//0x8A
        mplew.writeInt(0);
...
//        mplew.writeZeroBytes(6);
    ...
    public static byte[] loadCategories() {
        ...
        //mplew.writeInt(0); // Removed in v148.1
