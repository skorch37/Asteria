        ...
        switch (onUserEnter.fromString(scriptName)) {
            ...
            case direction_59063: {
                try {
                    ...
                    c.getSession().write(CWvsContext.getTopMsg("On voyage to Nautilus.",0,0));
            ...
            case Advanture_tuto00: {
                try {
                    ...
                    c.getSession().write(UIPacket.getDirectionInfo(1, 2100));
                    Thread.sleep(2800);
                    c.getSession().write(CWvsContext.getTopMsg("Press the left and right keys to move.",0,0));
                    c.getSession().write(UIPacket.getDirectionInfo(1, 3000));
                    Thread.sleep(3000);
                    c.getSession().write(CWvsContext.getTopMsg("Go to where the portal is and press the up key to move to the next map.",0,0));
                    //Thread.sleep(3000);
                    //c.getSession().write(CWvsContext.getNewTopMsg("Welcome to Maple World. We're one big family!"));
                } catch (InterruptedException e) {
                }
                c.getSession().write(UIPacket.IntroEnableUI(0));
                break;
            ...
            case Advanture_tuto01: {
                try {
                    ...
                    c.getSession().write(UIPacket.getDirectionInfo(1, 1800));
                    Thread.sleep(1800);
                    c.getSession().write(CWvsContext.getTopMsg("Press the Ctrl key to use normal attacks.",0,0));
                } catch (InterruptedException e) {
                }
                c.getSession().write(UIPacket.IntroEnableUI(0));
                break;
            ...
            case Advanture_tuto10: {
                try {
                    ...
                    c.getSession().write(CWvsContext.getTopMsg("Press the down key and Alt at the same time to go down.",0,0));
                } catch (InterruptedException e) {
                }
                c.getSession().write(UIPacket.IntroEnableUI(0));
...
//                }
            ...
            case Advanture_tuto33: {
                c.getPlayer().getMap().resetFully();
                c.getSession().write(CWvsContext.getTopMsg("Eliminate Mano.",0,0));
            ...
            case enter_101070000: {
                try {
                    c.getSession().write(CWvsContext.getTopMsg("The forest of fairies seems to materialize from nowhere as you exit the passage.",0,0));
                    Thread.sleep(2000);
                } catch (InterruptedException e) {
                }
            ...
            case cannon_tuto_direction1: {
                try {
                    ...
                    c.getSession().write(CField.environmentChange("cannonshooter/flying", 12));
                    c.getSession().write(UIPacket.getDirectionInfo("Effect/Direction4.img/effect/cannonshooter/balloon/0", 9000, 0, 0, 1, 0));
                    c.getSession().write(CField.UIPacket.getDirectionInfo((byte) 1, 1500));
                    Thread.sleep(1500);
                    c.getSession().write(UIPacket.getDirectionInfo("Effect/Direction4.img/effect/cannonshooter/balloon/1", 9000, 0, 0, 1, 0));
                    c.getSession().write(CField.UIPacket.getDirectionInfo((byte) 1, 1500));
                    Thread.sleep(1500);
                    c.getSession().write(UIPacket.getDirectionInfo("Effect/Direction4.img/effect/cannonshooter/balloon/2", 9000, 0, 0, 1, 0));
            ...
            case check_q20833:
                if (c.getPlayer().getQuestStatus(20833) == 1) {
                    ...
                    c.getSession().write(CWvsContext.getTopMsg("Who's that on the right of the map?",0,0));
                }
                break;
            case q2614M:
...
//                c.getPlayer().setDirection(0);
            ...
            case dubl2Tuto0: {
                ...
                c.getSession().write(UIPacket.IntroDisableUI(true));
                c.getSession().write(CWvsContext.getTopMsg("The Secret Garden Depths",0,0));
                c.getSession().write(CWvsContext.getTopMsg("On a rainy day...",0,0));
            ...
            case map_913070000: {
                try {
                    c.getSession().write(CField.UIPacket.IntroEnableUI(1));
                    c.getSession().write(CField.UIPacket.IntroDisableUI(true));
                    c.getSession().write(CWvsContext.getTopMsg("Mr.Limbert's General Store",0,0));
                    c.getSession().write(CField.UIPacket.getDirectionInfo((byte) 1, 500));
                    Thread.sleep(500);
                    c.getSession().write(CWvsContext.getTopMsg("Month 3, Day 4",0,0));
                    c.getSession().write(CField.UIPacket.getDirectionInfo((byte) 1, 1000));
                    Thread.sleep(1000);
            ...
            case map_913070002: {
                c.getSession().write(CWvsContext.getTopMsg("Mr.Limbert's General Store",0,0));
                c.getSession().write(CWvsContext.getTopMsg("Month 3, Day 8",0,0));
                break;
            }
            case map_913070020: {
                c.getSession().write(CWvsContext.getTopMsg("Mr.Limbert's General Store",0,0));
            ...
            case map_913070004: {
                try {
                    ...
                    c.getSession().write(CField.UIPacket.IntroDisableUI(true));
                    c.getSession().write(CWvsContext.getTopMsg("Mr.Limbert's General Store",0,0));
                    c.getSession().write(CWvsContext.getTopMsg("Month 3, Day 11",0,0));
                    Thread.sleep(500);
                    c.getSession().write(CField.UIPacket.getDirectionInfo((byte) 3, 2));
                    c.getSession().write(CField.UIPacket.getDirectionInfo((byte) 1, 1000));
                    Thread.sleep(1000);
                    ...
                    c.getSession().write(CField.UIPacket.getDirectionInfo((byte) 1, 1000));
                    Thread.sleep(1000);
                    c.getSession().write(CWvsContext.getTopMsg("Someone suspicious is in the back yard...",0,0));
                } catch (InterruptedException ex) {
                }
                c.getSession().write(CField.UIPacket.IntroEnableUI(0));
                c.getSession().write(CField.UIPacket.IntroDisableUI(false));
            ...
            case map_913070050: {
                try {
                    ...
                    c.getSession().write(CField.UIPacket.IntroEnableUI(1));
                    c.getSession().write(CField.UIPacket.IntroDisableUI(true));
                    c.getSession().write(CWvsContext.getTopMsg("General Store Yard",0,0));
                    c.getSession().write(CField.getClock(10 * 60));
                    MapTimer.getInstance().schedule(new Runnable() {
                        @Override
                        public void run() {
