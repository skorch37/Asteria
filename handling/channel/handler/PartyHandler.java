...
public class PartyHandler {
    ...
    public static final void PartyOperation(LittleEndianAccessor slea, MapleClient c, MapleCharacter chr) {
            ...
            case 4:
                ...
                if (theCh > 0) {
                    ...
                    if ((invited != null) && (invited.getParty() == null) && (invited.getQuestNoAdd(MapleQuest.getInstance(122901)) == null)) {
                        ...
                        if (party.getMembers().size() < 6) {
                            c.getPlayer().dropMessage(6, invited.getName() + " invited");
                        } else {
                            c.getPlayer().dropMessage(-6, "The party is full.");
                        }
                    } else {
                        c.getPlayer().dropMessage(-6, "This player is already in a party.");
                    }
                } else {
                    c.getPlayer().dropMessage(-6, "This player could not be found in the current server.");
                }
                break;
            case 6://was5
