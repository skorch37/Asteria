    ...
    public static final void BuddyOperation(final LittleEndianAccessor slea, final MapleClient c) {
        ...
        if (mode == 1) { // add
            ...
            if (ble != null && (ble.getGroup().equals(groupName) || !ble.isVisible())) {
                c.getSession().write(BuddylistPacket.buddylistMessage((byte) 24));// if its exists
                ...
                c.getSession().write(BuddylistPacket.buddylistMessage((byte) 24));// Buddy is full
            } else {
                try {
            ...
            if (!buddylist.isFull() && ble != null && !ble.isVisible()) {
                ...
                c.getSession().write(BuddylistPacket.updateBuddylist(buddylist.getBuddies(), 7)); // was 10
