...
public class WorldConstants {
    ...
    public static enum WorldOption {
        ...
        Scania(0, 1, 100, 1, (byte) 3, true, true, 20);//GMS like
        ...
        public static final String recommendedmsg = "MechDEV v"+ServerConstants.MAPLE_VERSION+"."+ServerConstants.MAPLE_PATCH;
